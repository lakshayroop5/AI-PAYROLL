...
export class EmailService {
  ...
  constructor(config: EmailConfig) {
    ...
    this.fromName = config.fromName || 'AI Payroll System';
  ...
  async sendSystemNotification(
    ...
    try {
      ...
      const template: EmailTemplate = {
        subject: `[AI Payroll System] ${subject}`,
        html: `
  ...
  private async generateInvoiceTemplate(invoiceData: any): Promise<EmailTemplate> {
    ...
    return {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <h1 style="color: #007cba;">AI Payroll System</h1>
          ...
          <p style="margin-top: 30px; font-size: 12px; color: #666;">
            This invoice was automatically generated by AI Payroll System.
